...
const FeatureSection = () => {
  return (
    <div id='Features' className="relative pt-4 pb-4 mt-0 sm:mt-4">
    <div className="text-center">
    <h2 className="text-2xl sm:text-3xl lg:text-5xl text-center text-black-500 tracking-wide font-bold my-10 lg:my-20">
